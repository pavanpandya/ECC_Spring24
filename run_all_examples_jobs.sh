...
hadoop jar /$HADOOP_HOME/share/hadoop/tools/lib/hadoop-streaming-3.3.6.jar -file /home/hadoop/Assignment_01/Part_02/Examples/Grep/mapper.py -mapper "/usr/bin/python3 /home/hadoop/Assignment_01/Part_02/Examples/Grep/mapper.py $pattern" -file /home/hadoop/Assignment_01/Part_02/Examples/Grep/reducer.py -reducer "/usr/bin/python3 /home/hadoop/Assignment_01/Part_02/Examples/Grep/reducer.py" -input /Input/access.log -output "$OUTPUT_DIR1" &
